...
class _UploadState extends State<Upload> {
 ...
 Reference reference = firebaseStorage.ref().child("postFolder").child(postId);//image name
...
setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: uint8list==null? Center(child: IconButton(onPressed: (){

        pickImg();

      }, icon: Icon(Icons.upload_outlined, size: 80,))):
      Column(
        ...
        Expanded(
          child: Padding(
            ...
            child: Container(
              ...
              child:  Image.memory(uint8list!, fit: BoxFit.fill,),),
          ),
        ),
